...
<%@ Register TagPrefix="uc1" TagName="Searching" Src="~/Controls/Search/Searching.ascx" %>
<%@ Register TagPrefix="uc1" TagName="HorizontalTopPrimary" Src="~/Controls/Menu/HorizontalTopPrimary.ascx" %>
        ...
        <div id="wrapper" style="margin-top: 20px">
            ...
            <div class="container">
                ...
                <div class="shop-cart" style="position: relative;">
                    ...
                    <div class="border shop-content" style="margin-top: 50px">
