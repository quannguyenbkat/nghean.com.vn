    ...
    public class Cart
    {
        ...
        public bool Add(ProductCart product)
        {
            ...
            else
            {
                ...
                b.ProductVat = (Convert.ToDecimal(b.Price) * (string.IsNullOrEmpty(productEntity.NewColumn6) ? Convert.ToDecimal(menuEntity.MenuIcon) : Convert.ToDecimal(productEntity.NewColumn6)) / 100 * b.Quantity).ToString();
