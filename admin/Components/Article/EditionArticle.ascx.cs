...
public partial class Admin_Components_Article_EditionArticle : BaseUserControl
{
    ...
    private void LoadDataFromEntity()
    {
        ...
        chkIsShowToolbar.Checked = articleEntity.IsFull;
    ...
    private ArticleEntity LoadDataToEntity()
    {
        ...
        //articleEntity.Source = ddlVocative.SelectedValue;
        articleEntity.Source = txtVocative.Text;
        ...
        articleEntity.TinTieuDiem = chkIsShowTitle.Checked ? 1 : 0;

        //articleEntity.TinLienQuan = RelatedArticle1.RelatedArticleId;
        articleEntity.TinLienQuan = ismImageId.ImageIDArray;
        
        //articleEntity.ImageArray = ismImageId.ImageIDArray;
        articleEntity.ImageArray = txtPosition.Text;
        ...
        articleEntity.VideoArray = txtFullName.Text;
        ...
        articleEntity.IsFull = chkIsShowToolbar.Checked;
