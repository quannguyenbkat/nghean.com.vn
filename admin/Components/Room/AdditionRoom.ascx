...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtRoomName" CssClass="input-text" Width="95%" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtPrice" CssClass="input-text" Width="200px" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtGioMoCua" CssClass="input-text" Width="200px" runat="server" /></div>
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtLink" CssClass="input-text" Width="200" runat="server" /></div>
        </div>
    </div>
...
<div class="frow" runat="server" >
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtViewed" CssClass="input-text" Width="100" runat="server" /></div>
        </div>
    </div>    
    <div class="frow">
        <div class="frow-wrapp">
