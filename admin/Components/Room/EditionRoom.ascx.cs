...
public partial class Admin_Components_Room_EditionRoom : BaseUserControl
{
    ...
    private void LoadDataFromEntity()
    {
        ...
        txtGioMoCua.Text = BicConvert.ToString(roomEntity.BriefDescription);
        ...
        txtWebsite.Text = roomEntity.Promotion;
        ddlPosition.SelectedValue = roomEntity.Priority.ToString();
        MenuUserUtils.BindingRadTreeViewRecursion(tvMenuUser, ddlLanguage.SelectedValue, "room");
    ...
    private RoomEntity LoadDataToEntity()
    {
        var roomEntity = new RoomEntity
        {
            ...
            BriefDescription = txtGioMoCua.Text,
    ...
    protected void ddlLanguage_SelectedIndexChanged(object o, EventArgs e)
    {
        ...
        MenuUserUtils.BindingRadTreeView(tvMenuUser, ddlLanguage.SelectedValue, "room");
    }
