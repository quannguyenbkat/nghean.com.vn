...
<div class="form-view">
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtName" CssClass="input-text" Width="97%" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                ...
                <%=BicResource.GetValue("Admin","Admin_FrameView_Oder") %>Thứ tự: {1}: MenuID, {2}:ParentID, {3}:Name, {4}:LanguageKey</div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
