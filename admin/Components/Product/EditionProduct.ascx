            ...
            <div class="frow-wrapp">
                ...
                <div class="input group-item">
                    <div class="col c1">
                        ...
                        <div class="line">
                            <div class="label arrow">
                                <telerik:RadCodeBlock ID="RadCodeBlock73" runat="server">
                                    Tiêu chuẩn áp dụng
                                </telerik:RadCodeBlock>
                            </div>
                            <div class="input">
                    ...
                    <div class="col c2">
                        <div class="line">
                            <div class="label arrow">
                                <telerik:RadCodeBlock ID="RadCodeBlock22" runat="server">
                                   <%-- <%=BicResource.GetValue("Admin","Admin_Product_Code") %>--%>
                                    Model
                                </telerik:RadCodeBlock>
                            </div>
                            <div class="input">
                        ...
                        <telerik:RadCodeBlock ID="RadCodeBlock72" runat="server">
                        <div class="line ">
                            <div class="label arrow">
                                Cấp bảo vệ
                            </div>
                ...
                <div class="input">
                    <telerik:RadCodeBlock ID="RadCodeBlock49" runat="server">
                        <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel2">
                            <uc3:CommentProduct ID="CommentProduct1" runat="server" />
                        </telerik:RadAjaxPanel>
                    </telerik:RadCodeBlock>
                </div>
            </div>
