...
public partial class admin_Components_Product_CommentProduct : UserControl
{
    ...
    private void GetDataSource()
    {
        ...
        bicData.Conditioning.Add(new ConditioningItem(CommentEntity.FIELD_ID, ProductID.ToString(), Operator.EQUAL, CompareType.NUMERIC));
    ...
    protected void lvRelatedProduct_ItemCommand(object source, ListViewCommandEventArgs e)
    {
        switch(e.CommandName)
        {
            case "IsActive":
                ...
                var updateIsActive = e.CommandArgument.Equals("True") ? 0 : 1;
                dhIsActive.UpdateColumn("IsActive", updateIsActive, "CommentID", ((HiddenField)e.Item.FindControl("HiddenField1")).Value, "Comment");
