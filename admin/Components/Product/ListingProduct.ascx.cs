...
public partial class Admin_Components_Product_ListingProduct : BaseUserControl
{
    ...
    protected void radMenuContext_ItemClick(object sender, RadMenuEventArgs e)
    {
        ...
        switch (e.Item.Value)
        {
            ...
            case "View":
                ...
                {
                    string prefix = "pd";
                    //if (productEntity.TypeOfControl == 1)
                    //    prefix = "nd";
                    //else
                    //    prefix = productEntity.TypeOfControl == 2 ? "gd" : "vd";
                    string link = string.Format(BicApplication.URLRoot + "{0}/{1}.{2}/{3}.{4}{5}.html",
                                                productEntity.LanguageKey, productEntity.MenuUserName,
                                                prefix + productEntity.MainMenuUserID,
                                                rgManager.Items[index].GetDataKeyValue("UrlName"),
                                                productEntity.IsFull ? "fs" : "i", id);
    ...
    protected void btnclear_OnClick(object sender, EventArgs e)
    {
        ...
        //BicSession.SetValue("ProductLanguage", BicXML.ToString("DefaultLanguage", "SearchEngine"));
