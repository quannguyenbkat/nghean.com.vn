...
public partial class Controls_Email_Email : BaseUIControl
{
    ...
    protected bool SendMailUser(string email)
    {
        ...
        var content = BicHtml.GetContents(string.Format("~/Controls/Email/email_{0}.htm", base.Language));
        ...
        return BicEmail.SendToCustomer(email, subject, content) && BicEmail.SendToWebMaster(subject, contentMaster, email, subject);
    }
